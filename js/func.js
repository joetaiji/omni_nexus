...
function gnb(el) {
    const   FLM = "fullmenu",
            $gnb1 = $("#gnb1"),
            $gnb1Depth1 = $gnb1.find('.topmenu>li'); //depth1이 있으면 $gnb1.find(".depth1")           

    if (el=="full") { //전체메뉴가 다 펼쳐지는 경우
        $gnb1.addClass(FLM)
	...
	//모바일메뉴
	const   $gnb2 = $("#gnb2"),
			$gnb2Depth1 = $gnb2.find('.topmenu_all>li');//depth1이 있으면 $gnb2.find(".depth1")
